...
```
room-organizer/
├── demo.html                  ← Generated frontend (for GitHub Pages/local viewing)
├── start.bat                  ← One-click Windows startup script
├── backend/
│   ├── build_frontend.py      ← Script to compile/generate the HTML frontend
│   ├── app/
...
│   ├── static/
│   │   ├── index.html         ← Served frontend (generated by build_frontend.py)
│   │   ├── landing_page.html  ← Standalone landing page
...
- **Frontend Compilation:** The `demo.html` and `backend/static/index.html` files are generated by `backend/build_frontend.py`. If you need to make structural UI changes, edit the Python script and run it, rather than editing the HTML files directly.
